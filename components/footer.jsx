...
const footterMenu = [
  ...
  {
    title: `Sobre ${config.general.appName}`,
    items: [
      ...
      { label: 'Otros', url: '/?artistregister=true' },
    ],
  },
  {
...
const Footer = (props) => {
  return (
    <footer className='relative isolate border-t-[1px]  border-base-300 py-8 shadow-sm lg:py-12'>
      <div className='mx-auto w-[calc(100%_-_2.5rem)] max-w-5xl lg:w-[calc(100%_-_4rem)]'>
                    ...
                    {submenu.items.map((item) => {
                      return (
                        <div key={item.url}>
                          <Link
                            href={item.url}
                            className='text-sm text-base-content lg:text-base'
                          >
                            {item.label}
                          </Link>
                        </div>
        ...
        <div className='mt-12 flex flex-col gap-3 lg:mt-20'>
          <div className='mt-3 flex justify-center lg:mt-5'>
            <Link
              href='#0'
              className='mx-1 my-0 inline-block text-base-content lg:mx-1.5'
              rel='nofollow'
            >
              <svg
                className='
            ...
            <Link
              href='#0'
              className='mx-1 my-0 flex flex-row items-center justify-center text-base-content lg:mx-1.5'
              rel='nofollow'
            >
          ...
          <div className='flex flex-col gap-3 text-center text-sm text-base-content lg:text-xs'>
            <p>&copy; by RicSala</p>
