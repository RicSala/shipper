...
const Testimonials1 = () => {
    return (
        <section className="py-12 bg-secondary-200 sm:py-16 lg:py-20">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="flex flex-col items-center">
                    <div className="text-center">
                        <p className="text-lg font-medium text-secondary-foreground font-pj">2,157 people have said how good Rareblocks</p>
