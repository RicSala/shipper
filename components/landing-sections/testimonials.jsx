        ...
        <div className="flex flex-col items-center">
          ...
          <div className="mt-8 text-center md:order-3 md:mt-16">
            <a
              href="#"
              title=""
              className="border-b-2 border-neutral pb-2 font-bold leading-7 text-base-content transition-all duration-200 hover:border-gray-600 hover:text-gray-600 focus:outline-none focus:ring-1 focus:ring-gray-900 focus:ring-offset-2"
            >
              {" "}
