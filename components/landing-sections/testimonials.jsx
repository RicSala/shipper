      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className='flex flex-col items-center'>
          <div className='text-center'>
            ...
            <h2 className='font-pj mt-4 text-3xl font-bold text-base-content sm:text-4xl xl:text-5xl'>
          ...
          <div className='mt-8 text-center md:order-3 md:mt-16'>
            <a
              href='#'
              title=''
              className='font-pj border-b-2 border-gray-900 pb-2 text-base font-bold leading-7 text-primary-content transition-all duration-200 hover:border-gray-600 hover:text-gray-600 focus:outline-none focus:ring-1 focus:ring-gray-900 focus:ring-offset-2'
            >
              {' '}
