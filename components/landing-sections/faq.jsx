      ...
      <div className="flex flex-col flex-wrap items-baseline gap-5 lg:flex-row">
        <div className="flex-1">
          ...
          <p>
            ...
            accusantium inventore similique molestiae provident sapiente odio
            facere, consequuntur enim quasi dolores eos quod minus atque
            possimus tenetur unde voluptatem culpa.{" "}
          </p>
        </div>
