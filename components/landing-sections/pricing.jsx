              ...
              <div className="relative z-10 flex h-full flex-col gap-5 rounded-lg bg-base-100 p-8 lg:gap-8">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    ...
                    {plan.description && (
                      <p className="mt-2 text-base-muted-content">
                        {plan.description}
                      </p>
                    )}
                  </div>
                ...
                <div className="flex gap-2">
                  {plan.priceAnchor && (
                    <div className="mb-[4px] flex flex-col justify-end text-lg ">
                      <p className="relative">
                        ...
                        <span className="text-base-muted-content">
                          {/* {plan.default_price} */}
                        </span>
                      </p>
                    </div>
                  ...
                  <div className="mb-[4px] flex flex-col justify-end">
                    <p className="text-xs font-semibold uppercase text-base-muted-content">
                      EUROS/MES
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="relative flex items-center justify-center gap-2 text-center text-sm font-medium text-base-muted-content">
