export default function TwBreaks(props) {
  return (
    <div className='fixed bottom-0 right-0 m-2 flex items-center rounded border border-gray-400 bg-gray-300 p-2 text-sm text-pink-600'>
      <svg
      ...
      <span className='ml-1 hidden font-extrabold sm:inline md:hidden'>
        {' '}
        sm
      </span>
      <span className='ml-1 hidden font-extrabold md:inline lg:hidden'>
        {' '}
        md
      </span>
      <span className='ml-1 hidden font-extrabold lg:inline xl:hidden'>
        {' '}
        lg
      </span>
