...
import { be, is } from "date-fns/locale";
...
export default async function Home() {
  return (
    <main className="gap flex min-h-screen flex-col items-center justify-between">
      ...
      <AnotherThing onChange={() => {}} name="" />
      <Pricing2 />
      <div className="flex flex-col gap-3">
        <MediaText textFirst className={""} />
        <MediaText textFirst={false} className={""} />
      </div>
      <Testimonials1 />
      <Faq />
      ...
      <CoolButton onClick={() => {}} className="h-16 w-60">
        Cool Button 😎
      </CoolButton>
